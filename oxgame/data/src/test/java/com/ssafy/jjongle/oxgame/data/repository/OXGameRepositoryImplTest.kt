...
/**
 * OXGame Repository Impl Test 회귀를 막기 위한 테스트입니다.
 *
...
class OXGameRepositoryImplTest {
    ...
    @Test
    fun startGameSession_startsLocalGameAndSavesSession() = runBlocking {
    ...
    @Test
    fun finishGameSession_savesLocalHistoryWithWrongAnswerNotes() = runBlocking {
        ...
        repository.finishGameSession(start.sessionKey)
